...
type EditTeacbInput struct {
	Id    int    `form:"id" json:"id" comment:"ID" validate:"required"`
	Name  string `form:"name" json:"name" comment:"姓名" validate:"required"`
	Iphone  string `form:"iphone" json:"iphone" comment:"iphone" validate:"required"`
	Major  string `form:"major" json:"major" comment:"major" validate:"required"`
	Subject  string `form:"subject" json:"subject" comment:"subject" validate:"required"`
	Flag  string `form:"flag" json:"flag" comment:"flag" validate:"required"`
	Advantage  string `form:"advantage" json:"advantage" comment:"advantage" validate:"required"`
	Address  string `form:"address" json:"address" comment:"address" validate:"required"`
	Technology  string `form:"technology" json:"technology" comment:"technology" validate:"required"`
	Sex  	string    `form:"sex" json:"sex" comment:"性别" validate:""`
}
...
type RemoveUserInput struct {
	ID string `form:"id" json:"id" comment:"ID" validate:"required"`
}
...
type BatchRemoveUserInput struct {
	IDS string `form:"ids" json:"ids" comment:"IDS" validate:"required"`
}


func (params *BatchRemoveUserInput) BindingValidParams(c *gin.Context) error {
	return public.DefaultGetValidParams(c, params)
}
