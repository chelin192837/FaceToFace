...
-(void)analyticalData:(BICPageRequest*)request
{
    ...
    [[BICProfileService sharedInstance] analytiInvitationInfo:request serverSuccessResultHandler:^(id response) {
        ...
        weakSelf.dataArray.count==0 ? [weakSelf setupNoDataOfSearchBiconome2:weakSelf.tableView With:((weakSelf.tableView.height-160)/2-20)]: [weakSelf hideNoDataOfSearchBiconome];
