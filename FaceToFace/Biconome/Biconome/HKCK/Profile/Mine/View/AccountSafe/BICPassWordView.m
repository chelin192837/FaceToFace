...
-(UITextField *)pwdField{
    if(!_pwdField){
        ...
        _pwdField.placeholder = LAN(@"请输入原密码");
//        [_pwdField setValue:UIColorWithRGB(0xC6C8CE) forKeyPath:@"_placeholderLabel.textColor"];
        NSMutableAttributedString *placeholderString = [[NSMutableAttributedString alloc] initWithString:_pwdField.placeholder?_pwdField.placeholder:@"" attributes:@{NSForegroundColorAttributeName : UIColorWithRGB(0xC6C8CE)}];
