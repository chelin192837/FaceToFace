...
@end
@implementation BICTipOnly2View
...
//    self.titleLabel.frame=CGRectMake(0, 20, CGRectGetWidth(self.topView.frame), 23);
    self.contentLabel.frame=CGRectMake(0, 0, CGRectGetWidth(self.topView.frame), 76);
//    self.cancelButton.frame=CGRectMake(24, CGRectGetMaxY(self.contentLabel.frame),108, 44);
    self.confirmButton.frame=CGRectMake(24, CGRectGetMaxY(self.contentLabel.frame), CGRectGetWidth(self.topView.frame)-48, 44);
}
