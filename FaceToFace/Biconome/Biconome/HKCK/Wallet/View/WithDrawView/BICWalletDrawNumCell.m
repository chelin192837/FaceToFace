...
-(void)setResponse:(GetWalletsResponse *)response
{
    ...
    NSMutableAttributedString *balanceValue2=[[NSMutableAttributedString alloc] initWithString:NumFormat(response.freeBalance)?NumFormat(response.freeBalance):@"" attributes:attributes];
    NSMutableAttributedString *balanceValue3=[[NSMutableAttributedString alloc] initWithString:response.tokenSymbol?response.tokenSymbol:@"" attributes:attributes2];
