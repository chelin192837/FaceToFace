...
//        _addTextView.frame=CGRectMake(16, CGRectGetMaxY(self.addressLab.frame)+12, KScreenWidth-32, 42);
...
//        _remarkTextView.frame=CGRectMake(16, CGRectGetMaxY(self.remarkLab.frame)+12, KScreenWidth-32, 30);
