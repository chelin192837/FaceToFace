...
-(void)setupUI:(NSArray*)titleArray{
    ...
    XHVerticalScrollview *scroller = [[XHVerticalScrollview alloc] initWithDelegate:self DataArray:titleArray BgColor:KTheme2BGColor Frame:CGRectMake(48,0,KScreenWidth-32-40-28-16, 48)];
