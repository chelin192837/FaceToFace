...
-(void)setResponse:(BICAppStoreResponse *)response{
    ...
    NSMutableAttributedString *str=[[NSMutableAttributedString alloc] initWithString:temp?temp:@"" attributes:attributes];
...
-(UIButton *)updateButton{
    if(!_updateButton){
        ...
        [_updateButton setTitle:LAN(@"立即更新") forState:UIControlStateNormal];
