...
- (UICollectionView *)titleCollectionView{
    if (!_titleCollectionView) {
        ...
        flowLayout.itemSize = CGSizeMake((SCREEN_WIDTH-48)/3, 32);
        ...
        _titleCollectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(0,0, kScreenWidth, 32) collectionViewLayout:flowLayout];
...
- (UICollectionView *)buySaleCollectionView{
    if (!_buySaleCollectionView) {
        ...
        _buySaleCollectionView.backgroundColor = KThemeBGColor;
...
//            cell.titleLabel.textColor = KThemeTextColor;
            ChangePriceType priceType=self.priceType?:ChangePriceType_Buy;
            if(priceType==ChangePriceType_Sale){
                cell.titleLabel.backgroundColor=rgb(251, 20, 83);
            }else{
                cell.titleLabel.backgroundColor=UIColorWithRGB(0x00CC66);
            }
//            cell.pointView.hidden =NO;
        ...
        {
//            cell.titleLabel.textColor = KThemeTextColor;
            cell.titleLabel.backgroundColor=KThemeText7Color;
//            cell.pointView.hidden =YES;
            cell.titleLabel.font = [UIFont systemFontOfSize:14];
            cell.titleLabel.textColor = UIColorWithRGB(0x666666);
        }
        return cell;
    }
...
- (void)setupUI{
    ...
    self.titleLabel.backgroundColor=KTheme2BGColor;
