...
-(instancetype)initWithNibWith2:(HorLineType)type
{
    self = [[NSBundle mainBundle] loadNibNamed:NSStringFromClass([self class]) owner:nil options:nil][0];
    [self setupUI2:type];
...
-(void)setupUI2:(HorLineType)type
{
...
-(void)setupUI:(HorLineType)type
{
    ...
    if (type==HorLineType_red) {
        self.bannerView.backgroundColor = kBICGetHomeCellBtnRColor;
        self.leftLab.textColor = KThemeTextColor;
        self.rightLab.textColor=UIColorWithRGB(0xFF3366);
    }

    if (type==HorLineType_Green) {
        self.bannerView.backgroundColor = kBICGetHomeCellBtnGColor;
        self.leftLab.textColor = KThemeTextColor;
        self.rightLab.textColor=UIColorWithRGB(0x00CC66);
    }
...
//        self.bannerView.backgroundColor = kBICGetHomeCellBtnRColor;
//        self.leftLab.textColor = KThemeTextColor;
//        self.rightLab.textColor=KThemeTextColor;
//    }
//
//    if (type==HorLineType_Green) {
//        self.bannerView.backgroundColor = kBICGetHomeCellBtnGColor;
