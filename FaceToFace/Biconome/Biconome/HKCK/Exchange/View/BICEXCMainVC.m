...
-(BICListUserRequest*)request
{
    if (!_request) {
        ...
        _request.coinName = [BICDeviceManager GetPairCoinName]?[BICDeviceManager GetPairCoinName]:@"BTC";
        _request.unitName = [BICDeviceManager GetPairUnitName]?[BICDeviceManager GetPairUnitName]:@"USDT";
    }
    return _request;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!celled) {
        ...
        celled.backgroundColor = KThemeBGColor;
    }
    ...
    if (self.dataArray.count==0) {
        ...
        bgView.backgroundColor =KThemeBGColor;
...
{
    kPOSTNSNotificationCenter(NSNotificationCenterScrollViewDidEndDragging, @(scrollView.contentOffset.y));
