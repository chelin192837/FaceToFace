...
-(void)setupUI:(CGRect)frame
{
    ...
    priceLab.textColor = KThemeTextColor;
    ...
    totalNumLab.textColor = KThemeTextColor;
    ...
    BicMoney.textColor = KThemeTextColor;
    ...
    YuanMoney.textColor = KThemeText2Color;
...
//            RSDLog(@"%@",responseM.data.amount);
               self.BicMoney.text = NumFormat(self.BicMoney.text);
                if([responseM.data.percent doubleValue]==0){
                    self.BicMoney.textColor=KThemeTextColor;
                    self.YuanMoney.textColor=KThemeTextColor;
                }else{
                    if([responseM.data.percent containsString:@"-"]){
                        self.BicMoney.textColor=UIColorWithRGB(0xFF3366);
                        self.YuanMoney.textColor=UIColorWithRGB(0xFF3366);
                    }else{
                        self.BicMoney.textColor=UIColorWithRGB(0x00CC66);
                        self.YuanMoney.textColor=UIColorWithRGB(0x00CC66);
                    }
                }
