...
-(void)setupUI
{
    ...
    [cancelBtn setTitleColor:KThemeTextColor forState:UIControlStateNormal];
    ...
    searchBar.barTintColor = KThemeText6Color;
    searchBar.layer.cornerRadius = kBICCornerRadius;
    searchBar.layer.masksToBounds = YES ;
    
    searchBar.backgroundImage = [UIImage imageFromContextWithColor:KThemeText6Color];
