...
-(void)setupUI
{
    ...
    [self.password1Tex setPlaceHolder:LAN(@"请输入新密码") placeHoldColor:[UIColor colorWithHexColorString:@"FFFFFF" alpha:0.4] off_X:10.f];
    self.password1Tex.layer.cornerRadius = kBICCornerRadius;
    
    self.password2Tex.layer.borderColor = [UIColor whiteColor].CGColor;
    [self.password2Tex setPlaceHolder:LAN(@"请确认新密码") placeHoldColor:[UIColor colorWithHexColorString:@"FFFFFF" alpha:0.4] off_X:10.f];
