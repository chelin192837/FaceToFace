...
-(UITextField *)passField{
    if(!_passField){
        ...
        _passField.placeholder = LAN(@"请输入新密码");
//        [_passField setValue:UIColorWithRGB(0xC6C8CE) forKeyPath:@"_placeholderLabel.textColor"];
        NSMutableAttributedString *placeholderString = [[NSMutableAttributedString alloc] initWithString:_passField.placeholder?_passField.placeholder:@"" attributes:@{NSForegroundColorAttributeName : UIColorWithRGB(0xC6C8CE)}];
...
-(UITextField *)confirmField{
    if(!_confirmField){
        ...
        _confirmField.placeholder = LAN(@"请确认新密码");
//        [_confirmField setValue:UIColorWithRGB(0xC6C8CE) forKeyPath:@"_placeholderLabel.textColor"];
        NSMutableAttributedString *placeholderString = [[NSMutableAttributedString alloc] initWithString:_confirmField.placeholder?_confirmField.placeholder:@"" attributes:@{NSForegroundColorAttributeName : UIColorWithRGB(0xC6C8CE)}];
