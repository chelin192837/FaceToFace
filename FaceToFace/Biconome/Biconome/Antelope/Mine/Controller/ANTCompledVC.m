...
@interface ANTCompledVC ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)viewDidLoad {
    ...
    [self initNavigationTitleViewLabelWithTitle:@"成交记录" titleColor:SDColorGray333333 IfBelongTabbar:NO];
