...
#define BICThemeConfigType @"BICThemeConfigType"
...
#define NSNotificationCenterScrollViewDidEndDragging @"NSNotificationCenterScrollViewDidEndDragging"
#define NSNotificationCenterScrollViewleftHidden @"NSNotificationCenterScrollViewleftHidden"

//指纹面部
#define BICFaceIDStatus [NSString stringWithFormat:@"BICFaceIDStatus-%@",[[NSUserDefaults standardUserDefaults] objectForKey:@"USERID"]]
...
//主题背景色 父view
#define KThemeBGColor [BICDeviceManager changeTheme:0]
//二级背景色 子view
#define KTheme2BGColor [BICDeviceManager changeTheme:1]
#define KTheme2BGColorValue [BICDeviceManager changeTheme:2]
//一级字体颜色 主要色
#define KThemeTextColor [BICDeviceManager changeTheme:3]
#define KThemeTextColorValue [BICDeviceManager changeTheme:4]
//二级字体颜色 次要色
#define KThemeText2Color [BICDeviceManager changeTheme:5]
//Tab-字体颜色 tab颜色
#define KThemeText3Color [BICDeviceManager changeTheme:6]
//交易页面颜色
#define KThemeText4Color [BICDeviceManager changeTheme:7]
//个别颜色定义 我的detailLabel
#define KThemeText5Color [BICDeviceManager changeTheme:8]
//搜索栏背景
#define KThemeText6Color [BICDeviceManager changeTheme:9]
//按钮背景 买入 卖出等
#define KThemeText7Color [BICDeviceManager changeTheme:10]
//线条颜色等
#define KThemeText8Color [BICDeviceManager changeTheme:11]
...
#define BICHomeSafeValidate @"BICHomeSafeValidate"
