...
@property (nonatomic, assign)CGRect showFrameOfTableView;
@property (nonatomic, assign)CGRect hideFrameOfTableView;
...
- (void)resetTableViewFrameWithSuperView:(UIView *)superView {
    ...
    self.showFrameOfTableView = CGRectMake(0, bounds.size.height - resultHeight, bounds.size.width, resultHeight);
    self.hideFrameOfTableView = CGRectMake(0, bounds.size.height, bounds.size.width, resultHeight);
}
