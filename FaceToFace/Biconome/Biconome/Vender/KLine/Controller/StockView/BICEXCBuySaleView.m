...
-(void)setupUI
{
    ...
    BICEXCHorLine * horLineTop = [[BICEXCHorLine alloc] initWithFrame2:CGRectMake(0,0, width,5*28) With:HorLineType_Green];
...
//    [self quickSortArrayBuySell:sellArr withLeftIndex:0 andRightIndex:sellArr.count-1];
    ...
    self.horLineTop.arr2 = responseM.data.BUY_ORDERS;
