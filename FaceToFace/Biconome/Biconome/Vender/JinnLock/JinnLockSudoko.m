...
//        
//        if ([_delegate respondsToSelector:@selector(sudoko:passwordDidCreate:errorPassword:)])
//        {
//            [_delegate sudoko:self passwordDidCreate:_password errorPassword:_errorPassword];
//        }
    }
}
...
- (void)endTrack
{
    ...
    if ([_delegate respondsToSelector:@selector(sudoko:passwordDidCreate:errorPassword:)])
    {
        [_delegate sudoko:self passwordDidCreate:password errorPassword:_errorPassword];
    }
...
- (void)drawRect:(CGRect)rect
{
    ...
    _errorPassword ? [[UIColor colorWithRed:255/255.0 green:51/255.0 blue:102/255.0 alpha:0.2] set] : [[UIColor colorWithRed:51/255.0 green:102/255.0 blue:255/255.0 alpha:0.2] set];
