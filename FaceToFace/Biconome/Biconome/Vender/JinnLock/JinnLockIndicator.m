...
//    NSLog(@"errorPassword--%d--password--%@---%@---%@",errorPassword,password,_circleArray,_selectedCircleArray);
    ...
    for (int i = 0; i < password.length; i++)
    {
        ...
        if (errorPassword) {
            [_circleArray[number.intValue] updateCircleState:JinnLockCircleStateFillRed];
        }else{
