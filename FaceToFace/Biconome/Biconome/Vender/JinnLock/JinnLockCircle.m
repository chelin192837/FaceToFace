...
//    NSLog(@"%d",self.state);
    ...
    switch (self.state)
    {
        case JinnLockCircleStateNormal:
        {
            [self drawEmptyCircleWithContext:context
                                 ...
                                 strokeColor:[UIColor clearColor]
                                   fillColor:[UIColor colorWithRed:242/255.0 green:242/255.0 blue:242/255.0 alpha:1.0]];
        }
            break;
        case JinnLockCircleStateSelected:
        {
            [self drawCenterCircleWithContext:context
                                   ...
                                   centerRect:CGRectMake(self.diameter * (0.5 - JINN_LOCK_CIRCLE_CENTER_RATIO / 2),
                                                         ...
                                                         self.diameter * JINN_LOCK_CIRCLE_CENTER_RATIO)
                                  strokeColor:[UIColor colorWithRed:51/255.0 green:102/255.0 blue:255/255.0 alpha:1.0]
                                    fillColor:[UIColor colorWithRed:51/255.0 green:102/255.0 blue:255/255.0 alpha:0.2]];
            //             JINN_LOCK_COLOR_BACKGROUND
        ...
        case JinnLockCircleStateFill:
        {
            ...
            break;
        case JinnLockCircleStateFillRed:
        {
            [self drawSolidCircleWithContext:context
                                        rect:CGRectMake(JINN_LOCK_CIRCLE_WIDTH / 2,
                                                        JINN_LOCK_CIRCLE_WIDTH / 2,
                                                        self.diameter - JINN_LOCK_CIRCLE_WIDTH,
                                                        self.diameter - JINN_LOCK_CIRCLE_WIDTH)
                                 strokeColor:[UIColor colorWithRed:255/255.0 green:51/255.0 blue:102/255.0 alpha:1.0]];
        }
            break;
        case JinnLockCircleStateError:
        {
            [self drawCenterCircleWithContext:context
                                   ...
                                   centerRect:CGRectMake(self.diameter * (0.5 - JINN_LOCK_CIRCLE_CENTER_RATIO / 2),
                                                         ...
                                                         self.diameter * JINN_LOCK_CIRCLE_CENTER_RATIO)
                                  strokeColor:[UIColor colorWithRed:255/255.0 green:51/255.0 blue:102/255.0 alpha:1.0]
                                    fillColor:[UIColor colorWithRed:255/255.0 green:51/255.0 blue:102/255.0 alpha:0.2]];
        }
            break;
        default:
            break;
