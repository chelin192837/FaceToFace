...
public class OssUtil {
    ...
    private String ossdir = "https://liuying192837.oss-cn-beijing.aliyuncs.com/";
    //文件存储目录
    ...
    public String uploadImg2Oss(MultipartFile file) {
        ...
        try {
           ...
           String nameStr = this.uploadFile2OSS(inputStream, name);
            String uploadAddress = ossdir+nameStr;
            return uploadAddress;//RestResultGenerator.createSuccessResult(name);
        } catch (Exception e) {
    ...
    private String uploadFile2OSS(InputStream instream, String fileName) {
        ...
        try {
            ...
            //上传文件
            String dateDir = new SimpleDateFormat(DateTimeUtils.YEAR_MONTH_DATE_FORMAT_FILE).format(new Date());


            OSSClient ossClient = new OSSClient(endpoint, accessKeyId, accessKeySecret);
            PutObjectResult putResult = ossClient.putObject(bucketName, dateDir + fileName, instream, objectMetadata);
